    ...
    return (
        <div className="border border-grey-light-1 rounded-lr p-[7px]">
            ...
            {props.dictionary.map((def: any, index: number) => {
                return (
                    <div className="grid grid-cols-[1fr_40px] lr:grid-cols-[1fr_200px_40px] border border-grey-light-1 rounded-md my-[7px] p-[7px]">
                        <h4 className="col-[1] text-[18px] p-[10px]">
                            {def.word == "" ? "Word" : def.word}
                        </h4>
                        <input
                            type="text"
                            className="col-[1/3] md:col-[1] border border-grey-light rounded w-[100%] mb-[5px] lr:w-[90%]"
                            placeholder="Word"
                            value={def.word}
                            onChange={(event) => {
                                props.setDictionary(
                        ...
                        <Popup
                            trigger={
                                <div className="popup-select col-[1/3] mb-[5px] lr:col-[2] lr:row-[1/3]">
                        ...
                        <TrashIcon
                            className="trash-icon col-[2] lr:col-[3] row-[1] lr:row-[1/3] w-[30px] h-[27px] self-center ml-auto"
                            onClick={() => {
                                const defs: any[] = [];
